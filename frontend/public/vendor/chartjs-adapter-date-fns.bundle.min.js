  ...
  var A = "midnight",
    ...
    V = {
      ...
      k: function (t, e, r) {
        var n = t.getUTCHours();
        return (
          0 === n && (n = 24), "ko" === e ? r.ordinalNumber(n, { unit: "hour" }) : E(n, e.length)
        );
      },
      m: function (t, e, r) {
      ...
      Y: {
        ...
        set: function (t, e, r, n) {
          ...
          if (r.isTwoDigitYear) {
            var i = _t(r.year, a);
            return (
              t.setUTCFullYear(i, 0, n.firstWeekContainsDate), t.setUTCHours(0, 0, 0, 0), G(t, n)
            );
          }
          var o = "era" in e && 1 !== e.era ? 1 - r.year : r.year;
          return (
            t.setUTCFullYear(o, 0, n.firstWeekContainsDate), t.setUTCHours(0, 0, 0, 0), G(t, n)
          );
        },
